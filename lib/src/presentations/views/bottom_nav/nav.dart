...
import 'package:green_globe/src/presentations/views/events/empty_event.dart';
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(
              context,
            ).push(MaterialPageRoute(builder: (_) => EmptyEventsPage()));
          },
          child: const Icon(Icons.add, color: Colors.green, size: 32),
        ),
      ),
